...
public class MergeSortTest {
    ...
    @Test
    public void testBasicMergeSort() {
        ...
        Queue<String> actual = MergeSort.mergeSort(queue);
    ...
    @Test
    public void testAdvancedMergeSort() {
        for (int j = 0; j < 10; j += 1) {
            ...
            Queue<Integer> actual = MergeSort.mergeSort(queue);
            Arrays.sort(toBeSorted);
    ...
    public static void main(String[] args) {
        jh61b.junit.TestRunner.runTests("all", MergeSortTest.class);
    }
}
