...
public class IntList {
    ...
    public static IntList catenate(IntList A, IntList B) {
        ...
        IntList tempB = B;
        tempC = C;
        tempC.head = tempA.head;
        while(tempA.tail != null){
            IntList copy = new IntList();
            copy.head = tempA.tail.head;
            copy.tail = null;
            tempC.tail = copy;
            tempA = tempA.tail;
            tempC = tempC.tail;
        }
        IntList copy2 = new IntList();
        copy2.head = tempB.head;
        tempC.tail = copy2;
        tempC = tempC.tail;
        while(tempB.tail != null){
            IntList copy = new IntList();
            copy.head = tempB.tail.head;
            copy.tail = null;
            tempC.tail = copy;
            tempB = tempB.tail;
            tempC = tempC.tail;
    ...
    public static IntList reverse(IntList A){
        IntList B = new IntList(A.head, null);
        while(A.tail != null){
            IntList temp = new IntList(A.tail.head, B);
            B = temp;
            A = A.tail;
        }
        return B;
