...
public class Plip extends Creature {
    ...
    private static final double LoseEnergyPerMove = 0.15;

    private static final double GainEnergyPerStay = 0.2;
    ...
    public Color color() {
        r = 99;
        b = 76;
        g = (int) ((double) (192.0 / 2.0) * this.energy) + 63;
        return color(r, g, b);
    }
